...
filePath <- "/home/ubuntu/emilia/csv_data/data_unif_constrained/"
...
# paramBreaks <- c(0, 0.8, 1.6, 2.4, 3.2, 4, 4.8)  # Example for "temperature"
...
# Define the title
title_plot <- ggdraw() + 
  draw_label("Figure X:\nSensitivity of Semantic Distance to Temperature", 
  fontface = "bold", 
  size = 22, 
  hjust = 0,
  vjust = 0,
