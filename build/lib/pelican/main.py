        ...
        for i in range(len(subjects)):
            ...
            if os.path.isdir(FILEPATH):
                ...
                documents.append(Document(FILEPATH, file_name, current_corpus,
                                          has_sections=configuration_settings['has_multiple_sections'],
                                          section_identifier=configuration_settings['section_identification'],
                                          number_of_sections=configuration_settings['number_of_sections']))
